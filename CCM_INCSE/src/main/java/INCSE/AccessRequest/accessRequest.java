...
public class accessRequest {
	...
	public static String authenticationTicket(String Qu, String ticket, String n) {
		...
		System.out.println("****************SHA256_7.2: " + (System.nanoTime() - multi));
		...
		System.out.println("****************AESCCM_7.3: " + (System.nanoTime() - multi));
	...
	public static String EncryptURL(String Sk, String Permission) {
		...
		int len = ccm.processBytes(hexStringToByteArray(toHex(URL)), 0, hexStringToByteArray(toHex(URL)).length,
				hexStringToByteArray(toHex(URL)), 0);
		try {
		...
		System.out.println("****************AESCCM_7.7: " + (System.nanoTime() - multi));
