...
//						"http://10.8.77.12:8080/AuthorizationServer/ClientAuthorizationManagement");
				HttpPost httpPost = new HttpPost(
						"http://127.0.0.1:8080/AuthorizationServer/ClientAuthorizationManagement");
				...
				// POST
				//System.out.println("===================>[BUG] before post content<===============");
				httpPost.setEntity(content);
				//System.out.println("===================>[BUG] after post content<===============");
